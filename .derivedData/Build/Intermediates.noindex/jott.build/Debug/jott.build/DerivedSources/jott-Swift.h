...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="jott",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4jott11AppDelegate")
...
SWIFT_CLASS("_TtC4jott19ImageTextAttachment")
@interface ImageTextAttachment : NSTextAttachment
- (nonnull instancetype)initWithData:(NSData * _Nullable)contentData ofType:(NSString * _Nullable)uti OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(macos,introduced=10.11);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

@protocol NSDraggingInfo;
SWIFT_CLASS("_TtC4jott21JottDropReceivingView")
@interface JottDropReceivingView : NSView
...
SWIFT_CLASS("_TtC4jott14JottNSTextView")
@interface JottNSTextView : NSTextView
...
@class NSWindow;
SWIFT_CLASS("_TtC4jott23LibraryWindowController")
...
SWIFT_CLASS("_TtC4jott12OverlayPanel")
...
SWIFT_CLASS("_TtC4jott13UpdateManager")
